...
{
    public abstract class DItemsPageBase : Page, INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler PropertyChanged;

        private string _itemId;
        private IEnumerable<DashboardDataItem> _items;

        public IEnumerable<DashboardDataItem> Items
        {
            get { return _items; }
        ...
        protected void OnItemGridViewContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
        {
            ...
            var item = args.Item as DashboardDataItem;
            if (item != null)
            {
        ...
        {
            var item = (DashboardDataItem)e.ClickedItem;
        ...
        protected void OnItemGridViewLoaded(object sender, RoutedEventArgs e)
        {
            if (_itemId != null)
            {
                ...
                var items = gridView.ItemsSource as IEnumerable<DashboardDataItem>;
